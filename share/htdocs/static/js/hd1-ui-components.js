...
class HD1UIComponents {
    ...
    initializeComponents() {
        ...
        this.components.set('applyenvironment', this.createApplyEnvironmentComponent());
        ...
        this.components.set('listprops', this.createListPropsComponent());
        ...
        this.components.set('instantiateprop', this.createInstantiatePropComponent());
        ...
        this.components.set('listenvironments', this.createListEnvironmentsComponent());
    ...
    // Component for POST /environments/{environmentId}
    createApplyEnvironmentComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ApplyEnvironment</h4><form id="applyEnvironment-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="applyEnvironment-result" class="result-area"></div></div>';
                this.attachEventListeners('applyenvironment', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.applyEnvironment(formData.param1, formData);
                    this.showResult('applyenvironment', result);
                    return result;
                } catch (error) {
                    this.showError('applyenvironment', error);
                    throw error;
                }
            }
        };
    ...
    createListObjectsComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ListObjects</h4><form id="listObjects-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><button type="submit">Execute</button></form><div id="listObjects-result" class="result-area"></div></div>';
    ...
    createCreateObjectComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>CreateObject</h4><form id="createObject-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="createObject-result" class="result-area"></div></div>';
    ...
    // Component for GET /props
    createListPropsComponent() {
        return {
            name: 'listprops',
            endpoint: '/props',
            method: 'GET',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ListProps</h4><form id="listProps-form"><button type="submit">Execute</button></form><div id="listProps-result" class="result-area"></div></div>';
                this.attachEventListeners('listprops', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.listProps();
                    this.showResult('listprops', result);
                    return result;
                } catch (error) {
                    this.showError('listprops', error);
                    throw error;
                }
            }
        };
    ...
    createGetObjectComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>GetObject</h4><form id="getObject-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="param2">Parameter 2:</label><input type="text" name="param2" required></div><button type="submit">Execute</button></form><div id="getObject-result" class="result-area"></div></div>';
    ...
    // Component for POST /sessions/{sessionId}/props/{propId}
    createInstantiatePropComponent() {
        return {
            name: 'instantiateprop',
            endpoint: '/sessions/{sessionId}/props/{propId}',
            method: 'POST',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>InstantiateProp</h4><form id="instantiateProp-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="param2">Parameter 2:</label><input type="text" name="param2" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="instantiateProp-result" class="result-area"></div></div>';
                this.attachEventListeners('instantiateprop', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.instantiateProp(formData.param1, formData.param2, formData);
                    this.showResult('instantiateprop', result);
                    return result;
                } catch (error) {
                    this.showError('instantiateprop', error);
                    throw error;
                }
            }
        };
    ...
    createListScenesComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ListScenes</h4><form id="listScenes-form"><button type="submit">Execute</button></form><div id="listScenes-result" class="result-area"></div></div>';
    ...
    createLoadSceneComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>LoadScene</h4><form id="loadScene-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="loadScene-result" class="result-area"></div></div>';
    ...
    // Component for GET /environments
    createListEnvironmentsComponent() {
        return {
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ListEnvironments</h4><form id="listEnvironments-form"><button type="submit">Execute</button></form><div id="listEnvironments-result" class="result-area"></div></div>';
                this.attachEventListeners('listenvironments', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.listEnvironments();
                    this.showResult('listenvironments', result);
                    return result;
                } catch (error) {
                    this.showError('listenvironments', error);
                    throw error;
                }
            }
        };
