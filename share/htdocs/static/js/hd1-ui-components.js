...
class HD1UIComponents {
    ...
    initializeComponents() {
        ...
        this.components.set('leavesessionworld', this.createLeaveSessionWorldComponent());
        ...
        this.components.set('listworlds', this.createListWorldsComponent());

        this.components.set('createworld', this.createCreateWorldComponent());
        ...
        this.components.set('postclientjoinsync', this.createPostClientJoinSyncComponent());
        ...
        this.components.set('changesessionavatar', this.createChangeSessionAvatarComponent());
        ...
        this.components.set('getsessionworldstatus', this.createGetSessionWorldStatusComponent());
        ...
        this.components.set('getworld', this.createGetWorldComponent());

        this.components.set('updateworld', this.createUpdateWorldComponent());

        this.components.set('deleteworld', this.createDeleteWorldComponent());
        ...
        this.components.set('joinsessionworld', this.createJoinSessionWorldComponent());

        this.components.set('getworldstatesync', this.createGetWorldStateSyncComponent());
    ...
    // Component for POST /sessions/{sessionId}/world/leave
    createLeaveSessionWorldComponent() {
        return {
            name: 'leavesessionworld',
            endpoint: '/sessions/{sessionId}/world/leave',
            method: 'POST',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>LeaveSessionWorld</h4><form id="leaveSessionWorld-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="leaveSessionWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('leavesessionworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.leaveSessionWorld(formData.param1, formData);
                    this.showResult('leavesessionworld', result);
                    return result;
                } catch (error) {
                    this.showError('leavesessionworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for GET /worlds
    createListWorldsComponent() {
        return {
            name: 'listworlds',
            endpoint: '/worlds',
            method: 'GET',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ListWorlds</h4><form id="listWorlds-form"><button type="submit">Execute</button></form><div id="listWorlds-result" class="result-area"></div></div>';
                this.attachEventListeners('listworlds', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.listWorlds();
                    this.showResult('listworlds', result);
                    return result;
                } catch (error) {
                    this.showError('listworlds', error);
                    throw error;
                }
            }
        };
    ...
    // Component for POST /worlds
    createCreateWorldComponent() {
        return {
            name: 'createworld',
            endpoint: '/worlds',
            method: 'POST',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>CreateWorld</h4><form id="createWorld-form"><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="createWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('createworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.createWorld(formData);
                    this.showResult('createworld', result);
                    return result;
                } catch (error) {
                    this.showError('createworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for POST /sessions/{sessionId}/sync/client-join
    createPostClientJoinSyncComponent() {
        return {
            name: 'postclientjoinsync',
            endpoint: '/sessions/{sessionId}/sync/client-join',
            method: 'POST',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>PostClientJoinSync</h4><form id="postClientJoinSync-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="postClientJoinSync-result" class="result-area"></div></div>';
                this.attachEventListeners('postclientjoinsync', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.postClientJoinSync(formData.param1, formData);
                    this.showResult('postclientjoinsync', result);
                    return result;
                } catch (error) {
                    this.showError('postclientjoinsync', error);
                    throw error;
                }
            }
        };
    ...
    // Component for POST /sessions/{sessionId}/world/sync
    createSyncSessionStateComponent() {
        return {
            name: 'syncsessionstate',
            endpoint: '/sessions/{sessionId}/world/sync',
            method: 'POST',
    ...
    // Component for GET /sessions/{sessionId}/world/graph
    createGetSessionGraphComponent() {
        return {
            name: 'getsessiongraph',
            endpoint: '/sessions/{sessionId}/world/graph',
            method: 'GET',
    ...
    // Component for PUT /sessions/{sessionId}/world/graph
    ...
    // Component for PUT /sessions/{sessionId}/avatar
    createChangeSessionAvatarComponent() {
        return {
            name: 'changesessionavatar',
            endpoint: '/sessions/{sessionId}/avatar',
            method: 'PUT',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>ChangeSessionAvatar</h4><form id="changeSessionAvatar-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="changeSessionAvatar-result" class="result-area"></div></div>';
                this.attachEventListeners('changesessionavatar', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.changeSessionAvatar(formData.param1, formData);
                    this.showResult('changesessionavatar', result);
                    return result;
                } catch (error) {
                    this.showError('changesessionavatar', error);
                    throw error;
                }
            }
        };
    ...
    // Component for GET /sessions/{sessionId}/world/status
    createGetSessionWorldStatusComponent() {
        return {
            name: 'getsessionworldstatus',
            endpoint: '/sessions/{sessionId}/world/status',
            method: 'GET',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>GetSessionWorldStatus</h4><form id="getSessionWorldStatus-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><button type="submit">Execute</button></form><div id="getSessionWorldStatus-result" class="result-area"></div></div>';
                this.attachEventListeners('getsessionworldstatus', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.getSessionWorldStatus(formData.param1);
                    this.showResult('getsessionworldstatus', result);
                    return result;
                } catch (error) {
                    this.showError('getsessionworldstatus', error);
                    throw error;
                }
            }
        };
    ...
    // Component for GET /worlds/{worldId}
    createGetWorldComponent() {
        return {
            name: 'getworld',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>GetWorld</h4><form id="getWorld-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><button type="submit">Execute</button></form><div id="getWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('getworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.getWorld(formData.param1);
                    this.showResult('getworld', result);
                    return result;
                } catch (error) {
                    this.showError('getworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for PUT /worlds/{worldId}
    createUpdateWorldComponent() {
        return {
            name: 'updateworld',
            endpoint: '/worlds/{worldId}',
            method: 'PUT',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>UpdateWorld</h4><form id="updateWorld-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="updateWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('updateworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.updateWorld(formData.param1, formData);
                    this.showResult('updateworld', result);
                    return result;
                } catch (error) {
                    this.showError('updateworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for DELETE /worlds/{worldId}
    createDeleteWorldComponent() {
        return {
            name: 'deleteworld',
            endpoint: '/worlds/{worldId}',
            method: 'DELETE',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>DeleteWorld</h4><form id="deleteWorld-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><button type="submit">Execute</button></form><div id="deleteWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('deleteworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.deleteWorld(formData.param1);
                    this.showResult('deleteworld', result);
                    return result;
                } catch (error) {
                    this.showError('deleteworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for POST /sessions/{sessionId}/world/join
    createJoinSessionWorldComponent() {
        return {
            name: 'joinsessionworld',
            endpoint: '/sessions/{sessionId}/world/join',
            method: 'POST',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>JoinSessionWorld</h4><form id="joinSessionWorld-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><div class="form-field"><label for="data">Request Body (JSON):</label><textarea name="data" placeholder="{}"></textarea></div><button type="submit">Execute</button></form><div id="joinSessionWorld-result" class="result-area"></div></div>';
                this.attachEventListeners('joinsessionworld', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.joinSessionWorld(formData.param1, formData);
                    this.showResult('joinsessionworld', result);
                    return result;
                } catch (error) {
                    this.showError('joinsessionworld', error);
                    throw error;
                }
            }
        };
    ...
    // Component for GET /sessions/{sessionId}/sync/world-state
    createGetWorldStateSyncComponent() {
        return {
            name: 'getworldstatesync',
            endpoint: '/sessions/{sessionId}/sync/world-state',
            method: 'GET',
            ...
            render: (containerId) => {
                ...
                container.innerHTML = '<div class="hd1-component"><h4>GetWorldStateSync</h4><form id="getWorldStateSync-form"><div class="form-field"><label for="param1">Parameter 1:</label><input type="text" name="param1" required></div><button type="submit">Execute</button></form><div id="getWorldStateSync-result" class="result-area"></div></div>';
                this.attachEventListeners('getworldstatesync', container);
            },
            
            execute: async (formData) => {
                try {
                    const result = await this.api.getWorldStateSync(formData.param1);
                    this.showResult('getworldstatesync', result);
                    return result;
                } catch (error) {
                    this.showError('getworldstatesync', error);
                    throw error;
                }
            }
        };
