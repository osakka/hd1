...
class HD1FormSystem {
    ...
    initializeSchemas() {
        ...
        this.formSchemas.set('joinSessionWorldForm', {
        "title": "JoinSessionWorld",
        "submitText": "Execute POST",
        "fields": {"param1": {"type": "string", "title": "Parameter 1", "required": true}, "data": {"type": "string", "title": "Request Body (JSON)", "placeholder": "{}"}}});
        ...
        this.formSchemas.set('updateWorldForm', {
        "title": "UpdateWorld",
        "submitText": "Execute PUT",
        "fields": {"param1": {"type": "string", "title": "Parameter 1", "required": true}, "data": {"type": "string", "title": "Request Body (JSON)", "placeholder": "{}"}}});
        ...
        this.formSchemas.set('createWorldForm', {
        "title": "CreateWorld",
        "submitText": "Execute POST",
        "fields": {"data": {"type": "string", "title": "Request Body (JSON)", "placeholder": "{}"}}});

        this.formSchemas.set('leaveSessionWorldForm', {
        "title": "LeaveSessionWorld",
        "submitText": "Execute POST",
        "fields": {"param1": {"type": "string", "title": "Parameter 1", "required": true}, "data": {"type": "string", "title": "Request Body (JSON)", "placeholder": "{}"}}});
        ...
        this.formSchemas.set('changeSessionAvatarForm', {
        "title": "ChangeSessionAvatar",
        "submitText": "Execute PUT",
        "fields": {"param1": {"type": "string", "title": "Parameter 1", "required": true}, "data": {"type": "string", "title": "Request Body (JSON)", "placeholder": "{}"}}});
