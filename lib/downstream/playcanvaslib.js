...
hd1.createEntityViaWorld = function(worldId, entityName, entityType, options = {}) {
    ...
    return Promise.reject(new Error('Entity management via world YAML only in v3.0'));
};

/**
 * HD1 v3.0: World lighting configuration
 */
hd1.configureWorldLighting = function(worldId, lightType, intensity = 1.0, color = '#ffffff') {
    ...
    return Promise.reject(new Error('Lighting management via world YAML only in v3.0'));
};

/**
 * Join session to world (v3.0 API)
 */
